...
avclass_labels = [
    (['W32.Sality.PE', 'Win.Virus.Sality-1067'],
     ['sality', (('sality', 'FAM:sality', 'FAM', 2), ('windows', 'FILE:os:windows', 'FILE', 2)), False]),

    (['Virus.Win32.Nimnul.lse3', 'Virus.Win32.Nimnul.e', 'Win32.Ramnit.N', 'Win32.Ramnit.N (B)'],
     ('wapomi', (('virus', 'CLASS:virus', 'CLASS', 2), ('wapomi', 'FAM:wapomi', 'FAM', 2), ('windows', 'FILE:os:windows', 'FILE', 3)), False)),

    (['W32/Poison.CWKQ!tr.bdr', 'W32.Backdoor.Poisonivy', 'Win32:Agent-AAGI [Trj]', 'Bck/Poison.E', 'win/malicious_confidence_100% (W)', 'Backdoor.Win32.PIvy.A'],
     ('poison', (('poison', 'FAM:poison', 'FAM', 3), ('windows', 'FILE:os:windows', 'FILE', 3)), False)),

    (['Program.Freemake.175', 'a variant of Win32/Freemake.A potentially unwanted', 'InstallCore', 'PUP.Optional.Freemake', 'Riskware/Freemake'],
     (None, (('grayware', 'CLASS:grayware', 'CLASS', 3), ('freemake', 'UNK:freemake', 'UNK', 4)), True)),
]

# Test parameters: Category, list of AVClassTag
avclass_category_tags = [
    ('FAM', [('poison', 'FAM:poison', 'FAM', 3), ('sality', 'FAM:sality', 'FAM', 2)]),  # Family section
    ('CLASS', [('grayware', 'CLASS:grayware', 'CLASS', 3), ('virus', 'CLASS:virus', 'CLASS', 2)]),  # Classification section
...
class TestAVClass:
    ...
    def test_start(target):
        from avclass.avclass2.lib.avclass2_common import AvLabels, Tagging, Taxonomy, Expansion
